...
def auto_create_ticker_table(symbols, start_date="2017-01-01", interval = '1d'):
    ...
    args:
        symbols (list): Tickers to use in creating models and analyzing
    ...
    print()
    print('********** Table Head **********')
    print(trunc_df_crypto.head(15))
    print('********** Table Tail **********')
    print(trunc_df_crypto.tail(15))
